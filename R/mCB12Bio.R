...
#' @import graphics
mCB12Bio<-function (x, a, b, k, m, lambda, method="B")
{
pdf_CB12Bio<-function(par,x){
a=par[1]
b=par[2]
k=par[3]
m=par[4]
...
res = suppressWarnings(AdequacyModel::goodness.fit(pdf = pdf_CB12Bio, cdf = cdf_CB12Bio, starts = c(a, b, k, m, lambda), data = x, method = method, mle = NULL))
